...
export default function OrderOnline() {
  ...
  const goToPay = () => {
    const countObj = {
      israeliSalad: [israeliSaladCount, israeliSaladCost],
      arais: [araisCount, araisCost],
      grilledPullet: [grilledPulletCount, grilledPulletCost],
      hamburgerCount: [hamburgerCount, hamburgerCost],
      colaCount: [colaCount, colaCost],
      beerCount: [beerCount, beerCost]
    }
